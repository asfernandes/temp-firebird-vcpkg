...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    file(
        INSTALL "${SOURCE_PATH}/output_${FB_ARCH}_release/lib/fbclient_ms.lib"
    ...
    file(
        INSTALL "${SOURCE_PATH}/output_${FB_ARCH}_release/lib/fbclient_static_ms.lib"
        DESTINATION "${CURRENT_PACKAGES_DIR}/lib"
    )
endif()
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    file(
        INSTALL "${SOURCE_PATH}/output_${FB_ARCH}_debug/lib/fbclient_ms.lib"
    ...
    file(
        INSTALL "${SOURCE_PATH}/output_${FB_ARCH}_debug/lib/fbclient_static_ms.lib"
        DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib"
    )
endif()
